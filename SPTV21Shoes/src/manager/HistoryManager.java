...
int history[];
    ...
    public History takeOnProduct(Product[] products, Customer[] customers){
        ...
        for (int i = 0; i < products.length; i++) {
            System.out.print(i+1+". "+products[i].getProductName()+". ");
            }
            System.out.println();
        ...
        int purchase = customers[numberCustomer-1].getCash()- products[numberProduct-1].getPrice();
        customers[numberProduct-1].setCash(purchase);
